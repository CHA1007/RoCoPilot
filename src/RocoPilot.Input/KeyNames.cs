...
public static class KeyNames
{
    ...
    private static Dictionary<string, InputKey> Build()
    {
        var t = new Dictionary<string, InputKey>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["comma"] = InputKey.Keyboard(0xBC),
            [","] = InputKey.Keyboard(0xBC),
            ["period"] = InputKey.Keyboard(0xBE),
            ["."] = InputKey.Keyboard(0xBE),
            ["slash"] = InputKey.Keyboard(0xBF),
            ["/"] = InputKey.Keyboard(0xBF),
            ["semicolon"] = InputKey.Keyboard(0xBA),
            [";"] = InputKey.Keyboard(0xBA),
            ["quote"] = InputKey.Keyboard(0xDE),
            ["'"] = InputKey.Keyboard(0xDE),
            ["minus"] = InputKey.Keyboard(0xBD),
            ["-"] = InputKey.Keyboard(0xBD),
            ["equal"] = InputKey.Keyboard(0xBB),
            ["="] = InputKey.Keyboard(0xBB),
            ["lbracket"] = InputKey.Keyboard(0xDB),
            ["["] = InputKey.Keyboard(0xDB),
            ["rbracket"] = InputKey.Keyboard(0xDD),
            ["]"] = InputKey.Keyboard(0xDD),
            ["backslash"] = InputKey.Keyboard(0xDC),
            ["\\"] = InputKey.Keyboard(0xDC),
            ["grave"] = InputKey.Keyboard(0xC0),
            ["`"] = InputKey.Keyboard(0xC0),
        };
        for (var i = 0; i < 12; i++)
        {
